...
public class PreferenceHelper {
    ...
    public void setPin(String csPin)
    {
        prefEditor.putString(AppConstants.PREF_KEY_PIN,csPin).commit();
    }
    ...
    {
        return sharedPreferences.getString(AppConstants.PREF_KEY_PIN,"");
    }
